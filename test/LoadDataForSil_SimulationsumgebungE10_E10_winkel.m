...
try
VD_Gyro_Front_Accel_X = getTimeSeries('ms_9dgps_front_accel_x_',fnames,ms);
VD_Gyro_Front_Accel_Y = getTimeSeries('ms_9dgps_front_accel_y_',fnames,ms);
VD_Gyro_Front_Accel_Z = getTimeSeries('ms_9dgps_front_accel_z_',fnames,ms);
VD_Gyro_Front_ARate_X = getTimeSeries('ms_9dgps_front_angular_rate_x_',fnames,ms);
VD_Gyro_Front_ARate_Y = getTimeSeries('ms_9dgps_front_angular_rate_y_',fnames,ms);
VD_Gyro_Front_ARate_Z = getTimeSeries('ms_9dgps_front_angular_rate_z_',fnames,ms);
VD_Gyro_Front_Comp_X = getTimeSeries('ms_9dgps_front_compass_x_',fnames,ms);
VD_Gyro_Front_Comp_Y = getTimeSeries('ms_9dgps_front_compass_y_',fnames,ms);
VD_Gyro_Front_Comp_Z = getTimeSeries('ms_9dgps_front_compass_z_',fnames,ms);
VD_Gyro_Front_Temp = getTimeSeries('ms_9dgps_front_state_cpu_temp_',fnames,ms);
VD_Gyro_Front_Angle_X = getTimeSeries('ms_9dgps_front_angle_alpha_',fnames,ms);
VD_Gyro_Front_Angle_Y = getTimeSeries('ms_9dgps_front_angle_beta_',fnames,ms);
VD_Gyro_Front_Angle_Z = getTimeSeries('ms_9dgps_front_angle_gamma_',fnames,ms);
catch
    disp("Fehler beim einlesen des vorderen 9D Sensors");
end

try
VD_Gyro_Rear_Accel_X = getTimeSeries('ms_9dgps_rear_accel_x_',fnames,ms);
VD_Gyro_Rear_Accel_Y = getTimeSeries('ms_9dgps_rear_accel_y_',fnames,ms);
VD_Gyro_Rear_Accel_Z = getTimeSeries('ms_9dgps_rear_accel_z_',fnames,ms);
VD_Gyro_Rear_ARate_X = getTimeSeries('ms_9dgps_rear_angular_rate_x_',fnames,ms);
VD_Gyro_Rear_ARate_Y = getTimeSeries('ms_9dgps_rear_angular_rate_y_',fnames,ms);
VD_Gyro_Rear_ARate_Z = getTimeSeries('ms_9dgps_rear_angular_rate_z_',fnames,ms);
VD_Gyro_Rear_Comp_X = getTimeSeries('ms_9dgps_rear_compass_x_',fnames,ms);
VD_Gyro_Rear_Comp_Y = getTimeSeries('ms_9dgps_rear_compass_y_',fnames,ms);
VD_Gyro_Rear_Comp_Z = getTimeSeries('ms_9dgps_rear_compass_z_',fnames,ms);
VD_Gyro_Rear_Temp = getTimeSeries('ms_9dgps_rear_state_cpu_temp_',fnames,ms);
VD_Gyro_Rear_Angle_X = getTimeSeries('ms_9dgps_rear_angle_alpha_',fnames,ms);
VD_Gyro_Rear_Angle_Y = getTimeSeries('ms_9dgps_rear_angle_beta_',fnames,ms);
VD_Gyro_Rear_Angle_Z = getTimeSeries('ms_9dgps_rear_angle_gamma_',fnames,ms);
catch
...
try
PT_MotorSpeed_FL = getTimeSeries('vd_ecu_motor_speed_can_fl_',fnames,ms);
PT_MotorSpeed_FR = getTimeSeries('vd_ecu_motor_speed_can_fr_',fnames,ms);
PT_MotorSpeed_RL = getTimeSeries('vd_ecu_motor_speed_can_rl_',fnames,ms);
PT_MotorSpeed_RR = getTimeSeries('vd_ecu_motor_speed_can_rr_',fnames,ms);
catch
